...
class Main(tk.Frame): #Создание главного окна
    ...
    def init_main(self): #Хранение и инициализайия данных
        ...
        self.refresh_img = tk.PhotoImage(file="./img/refresh.png")  # Изображение для кнопки обновления
        btn_refresh = tk.Button(
            toolbar, bg="#d7d8e0", bd=0, image=self.refresh_img, command=self.view_records  )  # Создание кнопки обновления
        btn_refresh.pack(side=tk.LEFT)  # Расположение кнопки обновления на главном окне
